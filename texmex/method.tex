...
\subsection{Loss function and Majorana criteria}
...
\subsection{Optimization strategy}\label{sec:optimization_strategy}
...
\section{Post-Optimization Analysis of the Setup}
\subsection{Hamiltonian reconstruction and parity classification}
...
\subsection{Spectral and local diagnostics}
...
\section{Braiding in an Effective Majorana Model}
...
\section{Braiding with Optimized Majorana Modes}
