...
\subsection{Dependence on interaction strength and system size}
...
\subsection{Trends in the optimized parameters}
...
\section{Braiding Results in the Effective Model}
...
\subsection{Evolution of the effective spectrum}
\begin{figure}[htbp]
  \centering
...
\subsection{Berry phase and ideal exchange behavior}
...
\section{Braiding Results for Optimized Majorana Modes}
...
\subsection{Projected microscopic braid}
\begin{figure}[htbp]
  \centering
...
\begin{figure}[htbp]
  ...
  \caption{Local-operator braid error up to $\dim P=80$. Here the braid is generated and judged using the projected local endpoint operators $P i(c^\dagger-c)P$. This is the more microscopic diagnostic, because it tests how well the exchange channel is accessed by a local physical coupling.}
